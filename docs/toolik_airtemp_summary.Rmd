...
# Command + shift + m adds the pipe operator automatically! 

# Pipe operator defines steps that you want to do to the item called, and you can nest combinations of steps to make nested functions 
